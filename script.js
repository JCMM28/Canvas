...
window.addEventListener('load', function(){
    ...
    canvas.width = 1000; //Se modifico la anchura del juego 
    canvas.height = 500;
    ...
    class Projectile{
        constructor(game, x, y){
            ...
            this.width = 10;
            this.height = 4;
            this.speed = 10; //se cambio la velocidad de los proyectiles 
    ...
    class Enemy {
        constructor(game){
            ...
            this.speedX = Math.random() * - 3.5 - 3.5; //se modifico la velocidad minima y la maxima de los enemigos para que todo se igual 
            this.markedForDeletion = false;
            this.lives = 10;  //Velocidad de enemigos 
        ...
        draw(context){
            ...
            if(this.game.gameOver){
                ...
                if(this.game.score > this.game.winningScore){
                    msg1 = 'Ganaste !'   //Se modifico el mensaje cuando ganas 
                    msg2 = "Lo hiciste bien!" //se modifico el segundo mensaje cuando ganas
                }else {
                    msg1 = 'Perdiste';  //se modifico el mensaje cuando pierdes 
                    msg2 = 'Rindete';  //se modifico el el segundo mensaje de cuando pierdes 
                }
    ...
    class Game{
        constructor(width, height){
            ...
            this.keys = [];
            this.ammo = 80; //Se modifico el numero de balas 
            this.ammoTimer = 0;
            this.ammoInterval = 600;
            this.maxAmmo = 80; //Se modifico el numero de balas que puede disparar juntas 
            this.enemies = [];
            this.enemyTimer = 0;
            this.enemyInterval = 800; //se modifico el intervalo de tiempo en los que aparecen los enemigos 
            this.gameOver = false;
            this.score = 0;
            this.winningScore = 65;
            this.gameTime = 0;
            this.timeLimit = 50000; //Se modifico el tiempo de juego 
            this.speed = 1;
            this.energy = 0;
            this.debug = true;
